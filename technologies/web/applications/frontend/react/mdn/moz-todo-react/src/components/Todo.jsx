...
function Todo(props) {
    ...
    // Custom hook take previous value of isEditing
    ...
    function handleSubmit(event) {
        ...
        // Callback prop
        props.onTaskEdit(props.id, newName);
        // I decide to not reset the value after
        setEditing(false);
    }
        ...
        <div className="stack-small">
            <div className="c-cb">
                <input
                    ...
                    onChange={() => props.onTaskToggle(props.id)}
                />
                <label className="todo-label" htmlFor={props.id}>
                    {props.name}
                </label>
